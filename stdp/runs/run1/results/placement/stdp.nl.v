module stdp (clk,
 ...
 sky130_fd_sc_hd__mux2_1 _097_ (.A0(\time_step_pre[0] ),
    .A1(net3),
    .S(net2),
    .X(_079_));
 sky130_fd_sc_hd__clkbuf_1 _098_ (.A(_079_),
    .X(_000_));
 sky130_fd_sc_hd__mux2_1 _099_ (.A0(\time_step_pre[1] ),
    .A1(net4),
    .S(net2),
    .X(_080_));
 sky130_fd_sc_hd__clkbuf_1 _100_ (.A(_080_),
    .X(_001_));
 sky130_fd_sc_hd__mux2_1 _101_ (.A0(\time_step_pre[2] ),
    .A1(net5),
    .S(net2),
    .X(_081_));
 sky130_fd_sc_hd__clkbuf_1 _102_ (.A(_081_),
    .X(_002_));
 sky130_fd_sc_hd__mux2_1 _103_ (.A0(\time_step_pre[3] ),
    .A1(net6),
    .S(net2),
    .X(_082_));
 sky130_fd_sc_hd__clkbuf_1 _104_ (.A(_082_),
    .X(_003_));
 sky130_fd_sc_hd__mux2_1 _105_ (.A0(\time_step_pre[4] ),
    .A1(net7),
    .S(net2),
    .X(_083_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _108_ (.A(_084_),
    .X(_005_));
 sky130_fd_sc_hd__mux2_1 _109_ (.A0(\time_step_pre[6] ),
    .A1(net9),
    .S(net2),
    .X(_085_));
 sky130_fd_sc_hd__clkbuf_1 _110_ (.A(_085_),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _111_ (.A0(\time_step_pre[7] ),
    .A1(net10),
    .S(net2),
    .X(_086_));
 ...
 sky130_fd_sc_hd__a21bo_1 _135_ (.A1(_032_),
    ...
    .B1_N(_092_),
    .X(_034_));
 sky130_fd_sc_hd__o22a_1 _136_ (.A1(net21),
    .A2(_092_),
    .B1(_034_),
    .B2(net13),
    .X(_012_));
 ...
 sky130_fd_sc_hd__nand2_1 _153_ (.A(_092_),
    .B(_049_),
    .Y(_050_));
 sky130_fd_sc_hd__o22a_1 _154_ (.A1(net23),
    .A2(_092_),
    .B1(_050_),
    .B2(net15),
    .X(_014_));
 ...
 sky130_fd_sc_hd__o21ai_1 _158_ (.A1(_051_),
    ...
    .B1(_053_),
    .Y(_054_));
 sky130_fd_sc_hd__mux2_1 _159_ (.A0(net24),
    .A1(_054_),
    .S(_092_),
    .X(_055_));
 ...
 sky130_fd_sc_hd__or2_1 _169_ (.A(net17),
    .B(_063_),
    .X(_064_));
 sky130_fd_sc_hd__mux2_1 _170_ (.A0(net25),
    .A1(_064_),
    .S(_092_),
    .X(_065_));
 ...
 sky130_fd_sc_hd__o21ai_1 _175_ (.A1(_066_),
    ...
    .B1(_068_),
    .Y(_069_));
 sky130_fd_sc_hd__mux2_1 _176_ (.A0(net26),
    .A1(_069_),
    .S(_092_),
    .X(_070_));
 sky130_fd_sc_hd__clkbuf_1 _177_ (.A(_070_),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _178_ (.A0(\time_step_post[0] ),
    .A1(net3),
    .S(net1),
    .X(_071_));
 sky130_fd_sc_hd__clkbuf_1 _179_ (.A(_071_),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _180_ (.A0(\time_step_post[1] ),
    .A1(net4),
    .S(net1),
    .X(_072_));
 sky130_fd_sc_hd__clkbuf_1 _181_ (.A(_072_),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _182_ (.A0(\time_step_post[2] ),
    .A1(net5),
    .S(net1),
    .X(_073_));
 sky130_fd_sc_hd__clkbuf_1 _183_ (.A(_073_),
    .X(_020_));
 sky130_fd_sc_hd__mux2_1 _184_ (.A0(\time_step_post[3] ),
    .A1(net6),
    .S(net1),
    .X(_074_));
 sky130_fd_sc_hd__clkbuf_1 _185_ (.A(_074_),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _186_ (.A0(\time_step_post[4] ),
    .A1(net7),
    .S(net1),
    .X(_075_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _189_ (.A(_076_),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _190_ (.A0(\time_step_post[6] ),
    .A1(net9),
    .S(net1),
    .X(_077_));
 sky130_fd_sc_hd__clkbuf_1 _191_ (.A(_077_),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _192_ (.A0(\time_step_post[7] ),
    .A1(net10),
    .S(net1),
    .X(_078_));
